...
if (file.exists(data_file)) {
  ...
  error_message <- paste("ERREUR: Fichier", data_file, "introuvable dans", getwd()) 
  print(error_message)
  show_load_error <- TRUE
  df <- NULL
}

# --- Création du Dataframe Vide (Fallback) ---
